    ...
    <v-container grid-list-md v-if="part">
        <v-layout row wrap>
            <v-flex xs12 sm10 offset-sm1 v-if="finishedDate">
                <v-card>
                    <v-responsive>
                        <v-img src="https://firebasestorage.googleapis.com/v0/b/ichlernedeutsch-97048.appspot.com/o/51_4912116_Abdruck.jpg?alt=media&token=55fa3e99-aba5-430b-92b9-f3b81ceaf99d" max-width="350px">
                        </v-img>
                    </v-responsive>
            ...
            <v-flex xs12 sm10 offset-sm1 class="text-xs-center">
                <v-dialog v-model="finishDialog" persistent max-width="600px">
                    <v-btn v-if="!finishedDate" slot="activator" color="success" dark @click="finishDialog = true"> 
                        <v-icon>mdi-check</v-icon>Я закончил читать эту часть!
                    </v-btn>
                    <v-card>
                        <v-responsive>
                            <v-img src="https://firebasestorage.googleapis.com/v0/b/ichlernedeutsch-97048.appspot.com/o/51_4912116_Abdruck.jpg?alt=media&token=55fa3e99-aba5-430b-92b9-f3b81ceaf99d" max-width="350px">
                        ...
                        <v-card-actions>
                            ...
                            <v-btn color="primary" dark text @click.native="finishWork">
                                <v-icon>mdi-check</v-icon>Я закончил работу!
                            </v-btn>
                        </v-card-actions>
                    </v-card>
                </v-dialog>      
